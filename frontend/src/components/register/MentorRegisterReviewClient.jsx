    ...
    <>
      ...
      <div className="grid sm:grid-cols-2 gap-6 pl-2 mt-8 pt-8 border-t border-gray-100">
        ...
        <div>
          ...
          <p className="text-sm font-bold text-gray-800">{f.language || "—"}</p>
        </div>
        <div>
          <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-1.5">
            Expertise area
          ...
          {f.startup_stage ? (
            Array.isArray(f.startup_stage) ? (
              f.startup_stage.length > 0 ? (
                f.startup_stage.map((stage, idx) => <p key={idx}>• {stage}</p>)
              ) : (
                <p>—</p>
              )
            ) : (
      ...
      <div className="mt-12 pt-8 border-t border-gray-100">
        <h2 className="text-xl font-bold text-[#115b4c] mb-6">
          Final Acknowledgements
        </h2>
        <div className="flex flex-col gap-4">
          <label className="flex items-start gap-4 cursor-pointer">
            <div className="relative flex items-center justify-center w-5 h-5 mt-0.5 rounded border border-gray-300 bg-white leading-none">
              ...
              />
              <div
                className={`${acceptedAccuracy ? "block" : "hidden"} text-[#167b66]`}
              >
                <svg
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 leading-relaxed">
                ...
                true and accurate to the best of my knowledge as of the date of
                submission.
              </p>
            </div>
          </label>
          ...
          <label className="flex items-start gap-4 cursor-pointer">
            <div className="relative flex items-center justify-center w-5 h-5 mt-0.5 rounded border border-gray-300 bg-white leading-none">
              ...
              />
              <div
                className={`${acceptedTerms ? "block" : "hidden"} text-[#167b66]`}
              >
                <svg
                  className="w-3.5 h-3.5"
                  fill="none"
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 leading-relaxed">
                ...
                <span className="text-[#167b66] hover:underline">
                  Privacy Policy
                </span>{" "}
                and{" "}
                <span className="text-[#167b66] hover:underline">
