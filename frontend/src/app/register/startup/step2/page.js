      ...
      <div className="hidden lg:flex w-[40%] bg-[#061e16] relative overflow-hidden flex-col justify-between py-12 px-12">
        ...
        <div className="relative z-10">
          ...
          <p className="text-[#10b981] text-sm leading-relaxed max-w-sm font-medium">
            Join a prestigious network of industry leaders curating the future
            of Ethiopia's innovation ecosystem through high-impact mentorship.
          </p>
        </div>
      ...
      <div className="w-full lg:w-[60%] flex flex-col pt-10 pb-6 px-4 md:px-8 overflow-y-auto">
        <div className="w-full max-w-2xl mx-auto flex flex-col">
          ...
          <RegistrationStepForm
            nextHref="/register/startup/step3"
          ...
          >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[10px] text-gray-500 mt-1">
                        Upload your startup logo (PNG, JPG, SVG)
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="Environment and Water">
            ...
            <div className="flex items-center gap-4 mt-4 pb-12">
              <button
                type="submit"
                className="px-8 py-4 flex justify-center items-center bg-[#0f5c4a] hover:bg-[#0c4a3b] text-white font-bold rounded-lg shadow-md transition text-sm min-w-[200px]"
              >
                Continue to Step 3
              </button>
              <div className="flex items-center gap-3 bg-[#f0f7f6] py-3.5 px-5 rounded-lg text-xs text-[#0f5c4a] flex-grow">
                ...
                Note: You will be asked to upload project files like your pitch
                deck and business plan in Step 4.
              </div>
            </div>
          </RegistrationStepForm>
        </div>
