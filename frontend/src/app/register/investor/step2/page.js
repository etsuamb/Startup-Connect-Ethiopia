...
export default function InvestorRegistrationStep2() {
  ...
  const f = fields || {};
  const selectedIndustries = Array.isArray(f.preferred_industry)
    ...
    <div className="min-h-screen bg-[#fcfcfc] font-sans text-gray-900 flex flex-col lg:flex-row">
      <div className="hidden lg:flex w-[40%] bg-[#061e16] relative overflow-hidden flex-col justify-between py-12 px-12">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-4xl lg:text-5xl font-light text-white mb-6 leading-tight">
            Empower the <br /> Next Generation <br /> of Ethiopian <br />{" "}
            Founders
          </h1>
          <p className="text-[#10b981] text-sm leading-relaxed max-w-sm font-medium">
            Share your investment preferences so we can introduce you to the
            most relevant founders and startups.
          </p>
        </div>
        <div className="relative z-10">
      ...
      <div className="w-full lg:w-[60%] flex flex-col pt-10 pb-6 px-4 md:px-8 overflow-y-auto">
        <div className="w-full max-w-2xl mx-auto flex flex-col">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-extrabold text-[#115b4c] tracking-tight mb-2">
              Investor Type and Profile
            </h1>
            <p className="text-gray-500 mb-10 text-[15px]">
              Tell us about your investment background and preferences to match
              you with relevant Ethiopian startups.
            </p>
          ...
          <div className="bg-white rounded-3xl shadow-[0_16px_40px_rgba(15,61,50,0.08)] border border-gray-100 p-8 md:p-10">
            <RegistrationStepForm
              nextHref="/register/investor/step3"
            ...
            >
              <section>
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <h2 className="text-lg font-bold text-[#0f3d32] mt-3">
                      Choose the description that best fits your investment
                      role.
                    </h2>
                  </div>
                </div>
                  ...
                  {[
                    ...
                    <label key={option} className="cursor-pointer">
                      <input
                        ...
                        defaultChecked={
                          option === f.investor_type ||
                          (!f.investor_type && option === "Individual")
                        }
                        required
                      />
              ...
              <section>
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <h2 className="text-lg font-bold text-[#0f3d32] mt-3">
                      Select the sectors and terms you prefer.
                    </h2>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                      {[
                        ...
                        <label
                          key={sector}
                          className="flex items-center gap-2 rounded-2xl border border-gray-200 px-3 py-2 text-xs font-bold text-gray-700 cursor-pointer hover:border-[#136150] transition"
                        >
                          <input
                            type="checkbox"
                            name="preferred_industry"
                            value={sector}
                            defaultChecked={selectedIndustries.includes(sector)}
                            className="text-[#136150] border-gray-300 rounded focus:ring-[#136150]"
                          />
                          {sector}
                        </label>
                      ))}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          required
                          defaultValue={f.investment_stage || ""}
                          className="w-full appearance-none rounded-xl border border-gray-200 bg-white px-4 py-3.5 text-sm text-gray-800 outline-none focus:border-[#136150] focus:ring-2 focus:ring-[#136150]"
                        >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          required
                          defaultValue={f.investment_range || ""}
                          className="w-full appearance-none rounded-xl border border-gray-200 bg-white px-4 py-3.5 text-sm text-gray-800 outline-none focus:border-[#136150] focus:ring-2 focus:ring-[#136150]"
                        >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          required
                          defaultValue={f.location_preference || ""}
                          className="w-full appearance-none rounded-xl border border-gray-200 bg-white px-4 py-3.5 text-sm text-gray-800 outline-none focus:border-[#136150] focus:ring-2 focus:ring-[#136150]"
                        >
                  ...
                  <div className="mt-4">
                    <label className="flex items-center gap-2 text-sm font-bold text-[#0f3d32]">
                      <input
                        ...
                        required
                        defaultChecked={
                          f.personal_verification === "Verified Investor"
                        }
                        className="h-4 w-4 rounded border-gray-300 text-[#136150] focus:ring-[#136150]"
                      />
                      I confirm that I am an accredited investor and the
              ...
              <div className="flex justify-between items-center mt-6 pt-8 border-t border-gray-200">
                <Link
                  href="/register/investor"
                  className="flex items-center gap-2 text-sm font-bold text-gray-600 hover:text-[#136150] transition"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
