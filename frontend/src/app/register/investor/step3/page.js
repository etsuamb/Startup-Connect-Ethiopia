      ...
      <div className="hidden lg:flex w-[40%] bg-[#061e16] relative overflow-hidden flex-col justify-between py-12 px-12">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-4xl lg:text-5xl font-light text-white mb-6 leading-tight">
            Build Ethiopia's next investment stories with real founder
            partnerships.
          </h1>
          <p className="text-[#10b981] text-sm leading-relaxed max-w-sm font-medium">
            Upload your investment documents so we can fast-track your approval
            and connect you to vetted opportunities.
          </p>
        </div>
        <div className="relative z-10">
        ...
        <div className="w-full max-w-2xl mx-auto flex flex-col">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 mb-10 text-[15px]">
              Upload the documents needed to complete your investor profile and
              verify your account.
            </p>
          ...
          <div className="bg-white rounded-3xl shadow-[0_16px_40px_rgba(15,61,50,0.08)] border border-gray-100 p-8 md:p-10">
            <RegistrationStepForm
              nextHref="/register/investor/step4"
            ...
            >
              <section className="grid gap-6">
                <div>
                  ...
                  <h2 className="text-lg font-bold text-[#0f3d32] mt-2">
                    Upload documents to support your investor profile.
                  </h2>
                </div>
                ...
                <div className="grid gap-6">
                  <label className="block text-sm font-bold text-[#0f3d32]">
                    ...
                    <p className="text-[12px] text-gray-500 mt-2">
                      Upload a company registration document if you are
                      investing through an entity. If you are registering as an
                      individual investor, upload a government-issued ID or
                      passport.
                    </p>
                  </label>
                  ...
                  <label className="block text-sm font-bold text-[#0f3d32]">
                    ...
                    <p className="text-[10px] text-gray-500 mt-2">
                      50–200 characters. This helps us match you with startups
                      aligned to your experience.
                    </p>
                  </label>
                </div>
                ...
                <label className="flex items-center gap-3 text-sm font-bold text-[#0f3d32]">
                  ...
                  />
                  I confirm these documents are accurate and that I am willing
                  to provide additional verification if requested.
                </label>
              </section>
