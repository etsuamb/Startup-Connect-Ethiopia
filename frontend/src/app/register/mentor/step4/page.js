...
import MentorRegisterReviewClient from "@/components/register/MentorRegisterReviewClient";

export default function MentorRegistrationReview() {
  return (
      ...
      <div className="hidden lg:flex w-[40%] bg-[#061e16] relative overflow-hidden flex-col justify-between py-12 px-12">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-4xl lg:text-5xl font-light text-white mb-6 leading-tight">
            Finalize your mentor profile and join the ecosystem.
          </h1>
          <p className="text-[#10b981] text-sm leading-relaxed max-w-sm font-medium">
            Review all your details before submission to ensure a seamless mentor onboarding experience.
          </p>
        </div>
      ...
      <div className="w-full lg:w-[60%] flex flex-col pt-10 pb-6 px-4 md:px-8 overflow-y-auto">
        <div className="w-full max-w-2xl mx-auto flex flex-col">
          <div className="w-full flex items-center gap-3 mb-6 pl-4">
            <Link href="/register/mentor/step3" className="text-[#167b66] hover:text-[#0f5c4a] transition">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
              </svg>
            </Link>
            <span className="font-bold text-lg tracking-tight text-[#115b4c]">Mentor Review</span>
          </div>

          <div className="mb-8">
            <h1 className="text-3xl font-extrabold text-[#115b4c] tracking-tight mb-2">Review and submit</h1>
            <p className="text-gray-500 mb-10 text-[15px]">Check your mentor profile information and submit the application once it is complete.</p>
            <div className="flex items-center justify-between mt-2">
              <span className="text-xs font-bold text-gray-400 tracking-wider uppercase">Step 4 of 4</span>
