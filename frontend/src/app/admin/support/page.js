	...
	return (
		<div className="max-w-3xl mx-auto pb-12">
			<section className="mb-8 rounded-2xl bg-[#0a4d3c] text-white p-8 border border-[#07382b]/20">
				...
				<p className="text-white/80 text-sm">Quick links and platform contacts for administrators.</p>
			</section>
			...
			<div className="bg-white rounded-2xl border border-slate-100 p-8 space-y-6">
				<div>
					...
					<ul className="text-sm text-slate-600 space-y-2">
						<li>
							...
							<Link href="/admin/activity" className="text-[#0a4d3c] font-semibold hover:underline">
								System activity
							</Link>{" "}
						...
						<li>
							...
							<Link href="/admin/users" className="text-[#0a4d3c] font-semibold hover:underline">
								Users
							</Link>{" "}
						...
						<li>
							...
							<Link href="/admin/payments" className="text-[#0a4d3c] font-semibold hover:underline">
				...
				<div className="rounded-xl bg-slate-50 border border-slate-100 p-4">
					...
					<p className="text-sm text-slate-600">
						...
						<Link href="/contact" className="text-[#0a4d3c] font-semibold hover:underline">
							Contact
						</Link>{" "}
						page.
					</p>
