      ...
      <header className="border-b border-gray-100 sticky top-0 bg-white z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
            ...
            <Link href="/contact" className="text-primary transition-colors border-b-2 border-primary pb-1">Contact</Link>
          </nav>
      ...
      <main className="flex-grow bg-[#fcfcfc]">
        ...
        <section className="pt-20 pb-12 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            We're here to support startups, investors, and mentors. Reach out with any questions or feedback.
          </p>
        </section>
        ...
        <section className="px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto mb-20">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-10 rounded-xl shadow-sm border border-gray-100 flex flex-col hover:shadow-md transition">
              ...
              <p className="text-gray-500 text-sm mb-8">Fill out the form below and our team will get back to you as soon as possible.</p>
              ...
              <form className="flex flex-col gap-5 flex-grow">
                ...
                <div className="pt-2">
                  <button type="button" className="px-6 py-3 bg-[#117663] text-white font-medium rounded-md hover:bg-primary-dark transition w-auto inline-block shadow-sm">Send Message</button>
                </div>
              </form>
            </div>
            ...
            <div className="bg-white p-10 rounded-xl shadow-sm border border-gray-100 flex flex-col hover:shadow-md transition">
              ...
              <p className="text-gray-500 text-sm mb-10">You can also reach us through the following channels:</p>
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white border border-gray-100 rounded-lg p-6 shadow-sm flex items-center justify-between cursor-pointer hover:border-gray-200 transition">
              <h3 className="font-medium text-gray-900">How do I register as a startup?</h3>
            ...
            {/* FAQ 2 */}
            <div className="bg-white border border-gray-100 rounded-lg p-6 shadow-sm flex items-center justify-between cursor-pointer hover:border-gray-200 transition">
              <h3 className="font-medium text-gray-900">How are startups verified?</h3>
              <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4"></path></svg>
            </div>
            
            {/* FAQ 3 */}
            <div className="bg-white border border-gray-100 rounded-lg p-6 shadow-sm flex items-center justify-between cursor-pointer hover:border-gray-200 transition">
              <h3 className="font-medium text-gray-900">How can I contact an investor or mentor?</h3>
              <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4"></path></svg>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#167b66] text-center px-4">
          <div className="max-w-4xl mx-auto flex flex-col items-center">
            <h2 className="text-3xl font-bold text-white mb-8">Join StartupConnect Ethiopia and grow your network.</h2>
            <button className="px-8 py-3 bg-white text-primary font-bold rounded-md hover:bg-gray-100 transition shadow-lg">Create an Account</button>
          </div>
        </section>
      </main>
