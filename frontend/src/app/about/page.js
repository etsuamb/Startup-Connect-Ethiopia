      ...
      <main className="flex-grow">
        ...
        <section className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-gray-900 mb-6 leading-tight">
            Empowering Ethiopia's Startup <br className="hidden md:block" /> Ecosystem
          </h1>
          <p className="text-lg text-gray-600 mb-10 mx-auto leading-relaxed">
            StartupConnect Ethiopia is a digital platform that brings together startups, investors, <br className="hidden md:block" /> and mentors in one trusted environment.
          </p>
        </section>
        ...
        <section className="py-20 bg-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center border-t border-gray-100">
          ...
          <div className="text-gray-600 space-y-6 text-lg leading-relaxed max-w-3xl mx-auto">
            <p>
              Many Ethiopian startups struggle to move beyond the idea or prototype stage because they lack access to funding, mentorship, and visibility. Investors also face difficulty finding credible, verified startups.
            </p>
            <p>
              There is no centralized digital platform that connects all stakeholders in the ecosystem, making collaboration difficult and slowing down innovation.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-gray-50 px-4 sm:px-6 lg:px-8 bg-[#fdfdfd]">
          <div className="max-w-6xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-600">StartupConnect Ethiopia provides a centralized platform where:</p>
            ...
            <div className="grid md:grid-cols-4 gap-6 mt-12 text-left">
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">Startups can showcase their ideas and upload pitch materials.</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">Investors can discover verified startups with potential.</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col">
                ...
                <h3 className="text-xl font-bold mb-3">Structured Mentorship</h3>
                <p className="text-gray-600 text-sm leading-relaxed">Mentors can guide founders through structured programs.</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">All users can communicate through chat and meetings.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left">
            <div className="bg-white p-10 rounded-xl shadow-sm border border-gray-100 shadow-md">
              ...
              <p className="text-gray-600 leading-relaxed">
                To empower Ethiopian startups by providing access to funding, mentorship, and visibility through a trusted digital platform.
              </p>
            </div>
            <div className="bg-white p-10 rounded-xl shadow-sm border border-gray-100 shadow-md">
              <div className="text-orange-400 mb-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                To become the leading digital hub for startup innovation and investment across Ethiopia.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto border-t border-gray-100">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-16">What We Stand For</h2>
          <div className="grid md:grid-cols-4 gap-6 text-left">
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col text-left">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">Verified profiles for startups, investors, and mentors.</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col text-left">
              <div className="text-primary mb-4">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">Encouraging meaningful connections and partnerships.</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col text-left">
              <div className="text-primary mb-4">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">Built specifically for Ethiopia's startup ecosystem.</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col text-left">
              <div className="text-primary mb-4">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">Available via web and mobile, with local payment integration.</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center hover:shadow-md transition">
              <div className="w-24 h-24 rounded-full bg-gray-200 mb-4 overflow-hidden relative">
                <div className="absolute inset-0 flex items-center justify-center text-gray-400 bg-gray-200 text-xs">Image</div>
              </div>
        ...
        <section className="py-20 bg-[#167b66] text-center px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-6">Join the platform and be part of Ethiopia's innovation future.</h2>
            <button className="px-8 py-3 mt-4 bg-white text-[#167b66] font-bold rounded-md hover:bg-gray-100 transition shadow-lg">Create an Account</button>
          </div>
        </section>
      </main>
